#
##
### Supporting R code for publication in Animal Behaviour
### "Dominance effects on urine washing and urinary odour profiles 
...
## 1.1. Dataset ----
# Behaviour dataset: Poirier-et-al_AnimalBehaviour_Dataset_FocalBehaviour.csv
...
## 1.2. Summary UW per indivdual, and boxplot UW by rank and season  ----
dev.new()
...
## 2.1. Datasets ----
# 2.1.1 Read csv ----
# Sample List: Poirier-et-al_AnimalBehaviour_Dataset_SampleList.csv
...
# Compound List: Poirier-et-al_AnimalBehaviour_Dataset_CompoundList.csv
